...
visualizeCCSMC(simpleModel, 128, true, 100)
## CCPF essentially will couple eventually in one shot with 2^14 particles
visualizeCCSMC(simpleModel, 2^14, true, 100)
...
visualizeCCSMC(simpleModel, simplelM, 16, :AS, true, 1000)
visualizeCCSMC(simpleModel, simplelM, 32, :AS, true, 1000)
visualizeCCSMC(simpleModel, simplelM, 64, :AS, true, 1000)
visualizeCCSMC(simpleModel, simplelM, 128, :AS, true, 1000)
